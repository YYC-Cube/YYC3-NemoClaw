...
The table is generated from [`ci/platform-matrix.json`](https://github.com/YYC-Cube/YYC3-NemoClaw/blob/main/ci/platform-matrix.json), the single source of truth kept in sync by CI and QA.
